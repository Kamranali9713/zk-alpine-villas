...
//               )}`}
            ...
            {settings.contact_email && (
              <a href={`mailto:${settings.contact_email}`} className="inline-flex w-fit rounded-sm border border-ink/20 px-6 py-3 text-sm text-ink hover:border-pine hover:text-pine transition-colors">
